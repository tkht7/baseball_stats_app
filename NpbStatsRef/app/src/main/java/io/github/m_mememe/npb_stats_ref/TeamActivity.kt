...
//    val URL = "http://127.0.0.1:8000/api/batting/" //ローカルホストを叩いてみる
    var result = ""
...
//            val result2 = result.get("results")
//            val result3: JSONArray = JSONArray(result2)
//            val result4 = result3.get("name")
//            textView.setText(result.get("count").toString())
//        }
//    }
